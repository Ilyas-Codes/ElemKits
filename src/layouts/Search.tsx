              ...
              <a aria-label={item.data.title} href={`/${item.slug}`}>
                <div className="group relative">
                  <img
                    ...
                    height={430}
                  />
                  <div className="hover-transition absolute right-0 top-0 flex items-center justify-center rounded-xl bg-light-blue opacity-0 shadow-xl shadow-dark-blue/10 group-hover:-translate-x-2 group-hover:translate-y-2 group-hover:opacity-100 dark:bg-dark-blue">
                    <a
